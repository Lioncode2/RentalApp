...
public class RentalServiceTests
{
    ...
    public async Task RequestRentalAsync_ValidDates_CreatesRental()
    {
        ...
        // Act
        var result = await _service.RequestRentalAsync(1, 2, DateTime.UtcNow, DateTime.UtcNow.AddDays(3));
    ...
    public async Task RequestRentalAsync_InvalidDates_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _service.RequestRentalAsync(1, 2, DateTime.UtcNow.AddDays(3), DateTime.UtcNow));
    }
    ...
    public async Task RequestRentalAsync_Overlap_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            _service.RequestRentalAsync(1, 2, DateTime.UtcNow, DateTime.UtcNow.AddDays(3)));
    }
